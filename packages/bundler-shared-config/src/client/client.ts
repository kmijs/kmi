...
const bundler = process.env.KMI_BUNDLER || 'rspack'
console.log(`[${bundler}] connecting...`)
...
function getPingUrl() {
  const h = getHost()
  return `${h.protocol}//${h.host}/__kmi_ping`
}
...
socket.addEventListener('close', async () => {
  ...
  console.info(`[${bundler}] Dev server disconnected. Polling for restart...`)
