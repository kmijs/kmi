...
let fsevents;
try {
  fsevents = __nccwpck_require__(764);
} catch (error) {
...
const Native = __nccwpck_require__(819);
...
const NodeFsHandler = __nccwpck_require__(357);
const FsEventsHandler = __nccwpck_require__(483);
const {
  EV_ALL,
  EV_READY,
  EV_ADD,
