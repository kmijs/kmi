 ...
 */
export declare const load: (content: string | import('../domhandler').AnyNode | import('../domhandler').AnyNode[] | Buffer, options?: import('./options').CheerioOptions | null | undefined, isDocument?: boolean) => import('./load').CheerioAPI;
/**
