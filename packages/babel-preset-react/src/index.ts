...
import { getCorejsVersion } from '@kmijs/shared'
  ...
  return {
    presets: [
      ...
      opts.presetReact !== false && [
        require.resolve('@kmijs/bundler-compiled/compiled/babel/preset-react'),
        {
          runtime: 'automatic',
    ...
    plugins: [
      ...
      opts.classPropertiesLoose && [
        require.resolve(
          '@kmijs/bundler-compiled/compiled/babel/plugin-proposal-private-methods',
        ),
        {
          loose: true,
        },
      ...
      opts.classPropertiesLoose && [
        require.resolve(
          '@kmijs/bundler-compiled/compiled/babel/plugin-proposal-private-property-in-object',
        ),
        {
          loose: true,
        },
