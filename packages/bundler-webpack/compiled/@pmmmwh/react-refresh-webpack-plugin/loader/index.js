...
const { validate: validateOptions } = require("@kmijs/bundler-compiled/compiled/schema-utils");
const { SourceMapConsumer, SourceNode } = require("@kmijs/bundler-compiled/compiled/source-map");
const {
